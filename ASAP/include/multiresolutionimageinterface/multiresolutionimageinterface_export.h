...
#      define MULTIRESOLUTIONIMAGEINTERFACE_EXPORT __attribute__((visibility("default")))
#    else
...
#    define MULTIRESOLUTIONIMAGEINTERFACE_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef MULTIRESOLUTIONIMAGEINTERFACE_DEPRECATED
#  define MULTIRESOLUTIONIMAGEINTERFACE_DEPRECATED __attribute__ ((__deprecated__))
#endif
