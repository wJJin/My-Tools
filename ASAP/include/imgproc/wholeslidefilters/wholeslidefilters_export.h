...
#      define WHOLESLIDEFILTERS_EXPORT __attribute__((visibility("default")))
#    else
...
#    define WHOLESLIDEFILTERS_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef WHOLESLIDEFILTERS_DEPRECATED
#  define WHOLESLIDEFILTERS_DEPRECATED __attribute__ ((__deprecated__))
#endif
